...
import { FileText, Image, File, Download, Shield, Plus } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  {/* Icon */}
                  <div
                    className={`p-3 sm:p-4 rounded-xl sm:rounded-2xl ${doc.bg} mb-3 sm:mb-4 group-hover:scale-105 sm:group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        {filteredDocuments.length === 0 && (
          <div className="text-center py-12 sm:py-16 bg-white rounded-xl sm:rounded-2xl border border-gray-200">
            <FileText
              size={48}
              className="sm:size-16 mx-auto text-gray-300 mb-3 sm:mb-4"
            />
